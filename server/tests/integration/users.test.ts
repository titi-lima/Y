...
describe('User Test', () => {
  ...
  it('shouldnt be possible to follow a person with an incorrect ID, case 1', async () => {
    console.log('Teste 2');
    const user1 = {
      nickName: 'john_doe',
      name: 'John Doe',
  ...
  it('shouldnt be possible to follow a person with an incorrect ID, case 2', async () => {
  ...
  it('shouldnt be possible to follow the same person twice', async () => {
    console.log('Teste 3');
    const user1 = {
      nickName: 'john_doe',
      name: 'John Doe',
    ...
    expect(response2.body.message).toBe(
      'This newFollowsId is already registred in userId follows',
    );
  });

  it('shouldnt be possible for the person to follow themselves', async () => {
    console.log('Teste 4');
    const user1 = {
      nickName: 'john_doe',
      name: 'John Doe',
  ...
  it('should be able to list follows', async () => {
    console.log('Teste 5');
    const user1 = {
      nickName: 'john_doe',
      name: 'John Doe',
  ...
  it('shouldnt be able to list follows with an incorrect ID', async () => {
    console.log('Teste 6');
    const user1 = {
      nickName: 'john_doe',
      name: 'John Doe',
  ...
  it('shouldnt be able to list followers with an incorrect ID', async () => {
    console.log('Teste 8');
    const user1 = {
      nickName: 'john_doe',
      name: 'John Doe',
